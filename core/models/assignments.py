...
class Assignment(db.Model):
    ...
    def grade_assignment(cls, _id, grade, principal: Principal):
        ...
        # NOTE: using raw ValidationError to satisfy tests
        if grade not in [e.value for e in GradeEnum]:
            raise ValidationError(message='grades outside GradeEnum is not allowed')
        # assertions.assert_valid(grade in [e.value for e in GradeEnum], 'grades outside GradeEnum is not allowed')
